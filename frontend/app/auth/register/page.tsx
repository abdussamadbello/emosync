 ...
 */
function get_password_rules(password: string) {
  return [
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm">
          <form onSubmit={handle_submit} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              {/* Password rules */}
              {(password_focused || password.length > 0) && (
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full rounded-lg border bg-transparent px-3 py-2 pr-10 text-sm outline-none placeholder:text-muted-foreground focus:ring-2 focus:ring-ring/30 ${
